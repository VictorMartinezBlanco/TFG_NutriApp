...
La salida se restringe con un esquema JSON que Ollama aplica durante la generación. Cada restricción lleva \texttt{type}, \texttt{priority} (\texttt{hard} o \texttt{soft}) y \texttt{weight} (1 a 10), y después solo los campos que su tipo necesita:
