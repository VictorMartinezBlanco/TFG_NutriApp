...
La prueba con nutricionistas está en curso en el momento de redactar esta versión. Sus pautas de mejora se incorporarán aquí y en la sección~\ref{sec:evalUsuarios} al cierre de la memoria.
...
En el motor, las reglas estructurales se asumen válidas para la población general y el profesional no puede anularlas caso a caso, así que una prescripción fuera de esos rangos, como la dieta renal que puso de ejemplo Pablo, se declararía infactible (sección~\ref{sec:estructurales}). El validador solo rechaza lo que el solver garantiza y avisa del resto, con lo que un plan con un micronutriente por encima del tope llega al profesional como aviso y no como rechazo (sección~\ref{sec:validador}). El término de reparto por comidas domina la función objetivo cuando está activo, el cociente entre nutrientes solo existe como restricción dura (sección~\ref{sec:objetivoResolucion}) y una restricción dura de energía o de macronutriente exige la igualdad exacta por día, sin la tolerancia que sí tienen las blandas. Con el catálogo de cien alimentos el solver no siempre demuestra el óptimo dentro del límite de tiempo, y ese límite es de 90 segundos con dos hilos porque el alojamiento gratuito no da para más (secciones~\ref{sec:evalEscalado} y~\ref{sec:evalHosting}).
...
En la evaluación, la prueba con nutricionistas sobre la aplicación desplegada está en curso (sección~\ref{sec:evalUsuarios}); los bancos del motor usan casos construidos a mano, no planes reales de profesionales; y la comparativa con los competidores se apoya en lo que sus webs decían en septiembre de 2026, que cambiará.
...
\begin{itemize}
    ...
    \item \textbf{Acompañantes.} Un rol de acompañante (tomate, cebolla, lechuga) que no consuma el tope de cuatro alimentos por comida, como señaló Pablo al revisar el tope; exige marcar ese rol en el catálogo.
    ...
    \item \textbf{Residuos de la capa de sentido común.} Un desayuno de solo frutos secos sigue siendo posible en teoría, y los tentempiés de una pieza y los alimentos sin perfil dependen de rangos genéricos. La calibración fina espera a las pautas de la prueba con nutricionistas.
\end{itemize}
...
Empecé este trabajo con la condición de que sirviera para algo real, y lo que más me ha enseñado es lo lejos que estaba mi primera idea de lo que los nutricionistas necesitaban. Sin las conversaciones con ellos habría construido una plataforma de gestión más, y el copiloto, la parte que da sentido al proyecto, no habría existido. La otra lección es la indicación de Alejandro y Pablo: la versión mínima que aplique las funcionalidades, verificada, vale más que una ambiciosa a medias. Aplicarla me costó al principio, porque suponía dejar fuera cosas que ya tenía diseñadas, pero es lo que permitió llegar a una aplicación desplegada y con un motor medido en vez de a un prototipo bonito. Lo que digan los profesionales cuando la usen es lo que queda por escuchar.
