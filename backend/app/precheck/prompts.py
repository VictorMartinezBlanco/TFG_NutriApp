...
SCOPE_SYSTEM = (
    ...
    "- in_scope: it states at least one dietary instruction or goal for the "
    "client.\n"
    "- out_of_scope: it is about anything else (other topics, general chat, "
    "requests unrelated to the client's diet).\n"
